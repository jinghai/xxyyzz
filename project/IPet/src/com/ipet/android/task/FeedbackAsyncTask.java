...
public class FeedbackAsyncTask extends AsyncTask<String, String, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        try {
            ...
            String uid = api.getCurrUserId();
            IpetUser user = api.getUserApi().getUser(uid);

            String text = "用户名：" + user.getLoginName() + "\r\n";
            text += "用户ID：" + user.getId() + "\r\n";
            text += "反馈内容：" + str;
            String subject = "[意见反馈]－" + user.getLoginName();
