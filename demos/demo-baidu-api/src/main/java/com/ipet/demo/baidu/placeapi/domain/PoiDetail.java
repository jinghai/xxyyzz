...
public class PoiDetail {
    ...
    /**
     * @param shop_hours the shop_hours to set
     */
    ...
    /**
     * @param overall_rating the overall_rating to set
     */
    ...
    /**
     * @param taste_rating the taste_rating to set
     */
    ...
    /**
     * @param service_rating the service_rating to set
     */
    ...
    /**
     * @param environment_rating the environment_rating to set
     */
    ...
    /**
     * @param facility_rating the facility_rating to set
     */
    ...
    /**
     * @param hygiene_rating the hygiene_rating to set
     */
    ...
    /**
     * @param technology_rating the technology_rating to set
     */
    ...
    /**
     * @param image_num the image_num to set
     */
    ...
    /**
     * @param groupon_num the groupon_num to set
     */
    ...
    /**
     * @param discount_num the discount_num to set
     */
    ...
    /**
     * @param favorite_num the favorite_num to set
     */
    ...
    /**
     * @param checkin_num the checkin_num to set
     */
